...
import Character.Drone;
import Character.Doctor;
import Character.Agressor;
import Character.Guide;
...
public class AdventureGame{
	...
	/*
	public MyCharacter create_and_addchar(String name, Location loc){
		MyCharacter mychar = new D
	}
	...
	public static void main(String[] args) {
		...
		MyCommands command = new MyCommands();
		command.gameLoop(hero);
